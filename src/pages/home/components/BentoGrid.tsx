...
const ITEMS: BentoItem[] = [
  {
    ...
    long:
      'WLS560은 V형 모노헐 양현에 너클파트를 더한 선형입니다. 선체가 하나라 건조와 계류는 단동선처럼 간편하면서, 물에 닿는 형상은 삼동선의 장점을 가져옵니다.',
    image:
  ...
  },
  {
    num: '02',
    title: 'Buoyancy',
    short: '너클파트가 부력을 키워 흔들림을 잡습니다.',
    long:
      '양현에 더한 너클파트가 부상능력과 부력을 키웁니다. 파도에 배가 눕는 롤링에 유리해, 사람이 한쪽으로 몰리거나 뱃전에서 고기를 걷어 올려도 배가 크게 기울지 않습니다.',
    image:
      'https://images.unsplash.com/photo-1541369470242-5e2ac9841992?w=2400&q=75&fm=jpg&fit=crop&auto=format',
    alt: '잔잔한 물 위에 떠 있는 보트',
  },
  {
    num: '03',
    title: 'Hold',
